...
import 'package:virtual_match/src/api/core/format/ApiGet.dart';
import 'package:virtual_match/src/model/entity/IEntity.dart';
import 'package:virtual_match/src/api/core/format/ApiAdd.dart';
import 'package:virtual_match/src/api/core/format/ApiUpdate.dart';
import 'package:virtual_match/src/api/core/format/ApiDelete.dart';

class FormatService with ChangeNotifier {
  bool isLoading = true;
