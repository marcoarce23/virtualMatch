...
class MiniTournamentBloc with Validators {
  ...
  void getAll() async {
    // final MiniTournamentos = await _MiniTournamentosProvider.cargarMiniTournamentos();
    // _MiniTournamentosController.sink.add(MiniTournamentos);
  }
