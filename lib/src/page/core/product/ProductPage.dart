...
import 'package:virtual_match/src/page/core/product/ProductDetailPage.dart';
...
const shoesBottom = [
  const Shoe(name: 'NIKE AIR-MAX', price: 170.00, image: 'assets/image/3.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 130.00, image: 'assets/image/4.png'),
];
                  ...
                  child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              notifyProvider.message = "Soy un nuevo mensaje";
