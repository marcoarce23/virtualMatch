...
class PlayerAllPage extends StatefulWidget {
  static final String routeName = 'playerAll';
  const PlayerAllPage({Key key}) : super(key: key);

  @override
  _PlayerAllPageState createState() => _PlayerAllPageState();
}

class _PlayerAllPageState extends State<PlayerAllPage> {
  int page = 0;
  final prefs = new Preferense();
  final List<Widget> optionPage = [LoadClientPage(), ClientListPage()];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("MIS CLIENTES", style: kTitleAppBar),
        // actions: <Widget>[
        //   IconButton(
...
class LoadClientPage extends StatefulWidget {
  static final String routeName = 'loadProduct';

  @override
  _LoadClientPageState createState() => _LoadClientPageState();
}

class _LoadClientPageState extends State<LoadClientPage> {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  text('CARGAR IMÁGENES DEL CLIENTE', AppTheme.themeBlackGrey,
                      1, 15.0),
